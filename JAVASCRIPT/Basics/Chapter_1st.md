...
## What is a Polyfills and transpilers?

- A transpiler converts modern JavaScript → older JavaScript
- Because not all browsers understand new JS features.
- For Example:
- Older browsers don’t understand arrow functions ❌
  - const add = (a, b) => a + b;
